...
module Lsr
  ...
  OptionParser.parse! do |parser|
    ...
    parser.on("--hide=PATTERN", "do not list implied entries matching shell PATTERN (overridden by -a or -A)") { puts "WONT IMPLEMENTED" }
    ...
    parser.on("-I", "--ignore=PATTERN", "do not list implied entries matching shell PATTERN") { |word| puts "WONT IMPLEMENTED" }
